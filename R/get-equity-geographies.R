...
#'
#' @param equity_type string, The type of equity geography either '50' (50 percent) or 'regavg' (regional average)
...
get_equity_geographies <- function(equity_type = '50', equity_group = 'race', year = '2019'){
  ...
  colnames(equity_tracts)[2] <- column_name_orig
  return(equity_tracts)
}
