...
This vignette explains how to calculate reliability measures for ACS metrics that require transformation. [This document from Census](https://www.census.gov/content/dam/Census/library/publications/2018/acs/acs_general_handbook_2018_ch08.pdf) provides background on how to estimate margins of error on user derived estimates.
