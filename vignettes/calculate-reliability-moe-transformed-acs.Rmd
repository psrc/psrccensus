...
Because these surveys are a sample, they have several sources of potential error such as sampling error, nonresponse error, coverage error, measurement error, and processing error.

The data team wanted to develop a set of rough guidelines to help team analysts to better understanding when [https://www.census.gov/content/dam/Census/library/publications/2018/acs/acs_general_handbook_2018_ch07.pdf sampling error] specifically could mean that the sample has quality issues and needs to be examined with additional scrutiny. 
...
These breakpoints are based on guidance from the [https://ofm.wa.gov/sites/default/files/public/legacy/pop/acs/ofm_acs_user_guide.pdf Census Bureau] and the [https://www.nctr.usf.edu/wp-content/uploads/2010/04/77802.pdf National Center for Transit Research]. It is important that analysts consider the nuances of their datasets to understand potential sources of error in their estimates. These internal categories are part of an ongoing conversation and may change.

###  Reliability is provided on all data tables retrieved via psrccensus
