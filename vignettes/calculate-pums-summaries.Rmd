...
```{r regional median, message=FALSE, eval=TRUE}
...
```{r regional median by category, message=FALSE, eval=TRUE}
...
```{r county median by category, message=FALSE, eval=TRUE}
...
```{r county count by category, message=FALSE, eval=TRUE}
