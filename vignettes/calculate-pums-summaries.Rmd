...
Notice, the API doesn't provide variable labels for data years prior to 2017; the label in those cases will be the variable value (consult the appropriate year data dictionary to interpret the value).
