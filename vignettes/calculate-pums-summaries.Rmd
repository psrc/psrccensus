...
## Obtaining PUMS data using psrccensus - the get_psrc_pums() function
...
### Manipulating data after get_psrc_pums()
...
## Generating summary statistics from PUMS using psrccensus
