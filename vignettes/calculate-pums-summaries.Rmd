...
get_psrc_pums(span = 1,                        # Denoting ACS 1-year estimates
              ...
              vars = "AGEP") %>%               # PUMS variable name for household income
  psrc_pums_median("AGEP")                     # Only 2nd arg is necessary (chaining)
```
...
ni <- get_psrc_pums(span = 5,                  # Denoting ACS 5-year estimates
                    ...
                    vars = c("HINCP","TEN"))   # PUMS household income & housing tenure variables
...
county_pums_count(ni, "TEN")                   # Second arg for grouping; primary variable is implicit
```
