...
```{r, include=FALSE}
psrc_pums_median_inc<-psrc_pums_median(span = 1,                  # Denoting ACS 1-year estimates
                 dyear = 2019,
...
```{r acs examples, message=FALSE, eval=FALSE}
psrc_pums_median_inc<-psrc_pums_median(span = 1,                  # Denoting ACS 1-year estimates
                 dyear = 2019,
                 target_var = "HINCP")      # The PUMS variable name for Household Income
...
```
```{r}
psrc_pums_median_inc
```

To calculate regional median household income by couple type (1	Opposite-sex husband/wife/spouse household
...
```{r, include=FALSE}
median_income_couple_type<-psrc_pums_median(span = 1,                  # Denoting ACS 1-year estimates
                 dyear = 2019,
                 target_var = "HINCP",      # The PUMS variable name for Household Income
                 group_var = "CPLT")       # Couple Type

```

```{r acs examples 2, message=FALSE, eval=FALSE}
median_income_couple_type<-psrc_pums_median(span = 1,                  # Denoting ACS 1-year estimates
                 dyear = 2019,
                 target_var = "HINCP",      # The PUMS variable name for Household Income
                 group_var = "CPLT")       # Couple Type
